    ...
    this.route.queryParams.subscribe(params => {
      ...
      if (params['rowIndex'] || Object.keys(params).length > 0) {
        ...
        if (!isNaN(rowIndex) && rowIndex > 0) {
          ...
          const orderDate = this.formatDateForInput(params['orderDate']) || null;
          const arriveDate = this.formatDateForInput(params['arriveDate']) || null;
          ...
          this.orderRequestForm.patchValue({
            rowIndex: rowIndex,
            orderType: shouldShowPlaceholder ? '' : this.normalizeOrderType(params['orderType']),
